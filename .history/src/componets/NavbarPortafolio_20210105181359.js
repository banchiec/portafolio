...
export default function NavbarPortafolio() {
    return (
        ...
        <nav id="navbar1" class="navbar navbar-expand-md navbar-dark ">
            ...
            <span   class="navbar-brand"> <span className="menor-mayor">&lt;</span> <span className="text-logo">Iván Espinoza</span><span className="menor-mayor">/</span><span className="menor-mayor">&gt;</span></span>
